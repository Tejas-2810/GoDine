...
function Signin() {
    ...
    async function handleSubmit(e) {
        ...
        const signin_endpoint = process.env.REACT_APP_SIGNIN_ENDPOINT || "api/auth/signin";
        ...
        if (userEmail !== '' && pwd !== '' && validEmail && validPassword) {
            ...
            if (response.status === 200 && response.data?.token && response.data?.role) {
                ...
                if (role === 'user') {
                    ...
                    navigate(from?.pathname ? from.pathname: '/dashboard', { replace: true });
                }
                else {
                        ...
                        <div className='card signin-card glass'>
                            ...
                            <form>
                                <div className='form-group m-1'>
                                    <label>Email</label>
                                    <input type='text' ref={emailRef} className='form-control' placeholder='Enter email' onInput={validateEmailAndSet} />
