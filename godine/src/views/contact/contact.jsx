...
const Contact = () => {
  ...
  const validateUserForm = () => {
    ...
    if (!userFormValues.phone) {
      ...
      !/^\d+$/.test(userFormValues.phone) ||
      userFormValues.phone.length != 10
    ) {
  ...
  const validateRestaurantForm = () => {
    ...
    if (!restaurantFormValues.email) {
      errors.email = "Email is required";
    } else if (!emailRegex.test(restaurantFormValues.email)) {
      errors.email = "Invalid email format.";
    }

    if (!restaurantFormValues.phone) {
      errors.phone = "Phone is required";
    } else if (!phoneRegex.test(restaurantFormValues.phone)) {
  ...
  const handleRestaurantFormSubmit = (e) => {
    ...
    if (validateRestaurantForm()) {
      ...
      alert("Restaurant form submitted successfully");
    }
  };
      ...
      <form onSubmit={handleUserFormSubmit}>
        ...
        <div className="form-group text-center">
          ...
          {userFormErrors.firstName && (
            <div className="invalid-feedback">{userFormErrors.firstName}</div>
          )}
        </div>
        <div className="form-group text-center">
          <input
          ...
          {userFormErrors.lastName && (
            <div className="invalid-feedback">{userFormErrors.lastName}</div>
          )}
        </div>
        <div className="form-group text-center">
          <input
          ...
          {userFormErrors.email && (
            <div className="invalid-feedback">{userFormErrors.email}</div>
          )}
        </div>
        <div className="form-group text-center">
          <input
          ...
          {userFormErrors.phone && (
            <div className="invalid-feedback">{userFormErrors.phone}</div>
          )}
        </div>
        <div className="form-group text-center">
          <textarea
            ...
            onChange={handleUserFormChange}
          />
          {userFormErrors.message && (
            <div className="invalid-feedback">{userFormErrors.message}</div>
          )}
        </div>
      ...
      <form onSubmit={handleRestaurantFormSubmit}>
        ...
        <div className="form-group text-center">
          ...
          {restaurantFormErrors.email && (
            <div className="invalid-feedback">{restaurantFormErrors.email}</div>
          )}
        </div>
        <div className="form-group text-center">
          <input
          ...
          {restaurantFormErrors.phone && (
            <div className="invalid-feedback">{restaurantFormErrors.phone}</div>
          )}
        </div>
        <div className="form-group text-center">
          <textarea
      ...
      <main>
        <div className="wrapper">
          <div ref={taebRef} className="taeb-switch left text-center">
            <div
              className={`taeb ${activeTab === "user" ? "active" : ""}`}
              taeb-direction="left"
            ...
            <div
              className={`taeb ${activeTab === "restaurant" ? "active" : ""}`}
