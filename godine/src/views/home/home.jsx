                ...
                <div className='container-sm hs'>
                    <div className=" m-5 p-5 hs1 ">
                        <form className='input-group bar  my-5' onSubmit={handleSubmit}>
                            <Button className='outline ' variant="warning" type="submit">Search</Button>
                            <input type="text" className='form-control form-control-h' placeholder="Search Restaurants or Food. . . . ." aria-label="Input group example" aria-describedby="basic-addon1" required />
                            <select className='form-select form-select-h' aria-label="Select Cuisine" style={{ backgroundColor: 'rgba(0, 0, 0, 0.336)', backdropFilter: 'blur(20px)', color: 'white', borderRadius: '1rem' }} >
                            ...
                            <select className='form-select form-select-h' aria-label="Select Location" style={{ backgroundColor: 'rgba(0, 0, 0, 0.336)', backdropFilter: 'blur(20px)', color: 'white', borderRadius: '1rem' }} required onChange={handleLocation}>
                        ...
                        <p className="quote text-center  " style={{ fontSize: '3vw' }}>“One cannot think well, love well, sleep well, if one has not dined well.” </p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-12">
                            <div className="row">
                                <div className="col-md-4 mb-3">
                                    <div className="card">
                                        <img className="img-fluid" alt="safdf" src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-0.3.5&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=1080&amp;fit=max&amp;ixid=eyJhcHBfaWQiOjMyMDc0fQ&amp;s=ee8417f0ea2a50d53a12665820b54e23" />
                                        <div className="card-body">
                                            <h4 className="card-title">Beach Restautrent</h4>
                                            <p className="card-text">Enjoy the beach as you eat, with a beautiful sunset.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-4 mb-3">
